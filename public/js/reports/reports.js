...
//                     rowHTML += `
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Observación semana 1"></textarea></td>
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Observación semana 2"></textarea></td>
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Observación semana 3"></textarea></td>
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Observación semana 4"></textarea></td>
...
//                 if (window.userRolId === 4) {
//                     rowHTML += `
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Documento..."></textarea></td>
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Documento..."></textarea></td>
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Documento..."></textarea></td>
//                         <td class="cell-textarea"><textarea spellcheck="false" placeholder="Documento..."></textarea></td>
//                         <td class="text-center">
